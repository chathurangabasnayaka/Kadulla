...
<div class="main-wrapper">
    ...
    <?php
    $pid = $_GET['pid'];
    $sql = "SELECT * from `publisher` where id='$pid'";
    ...
    <div class="related-product pb-115">
        <div class="container">
            <div class="section-title mb-45 text-center">
                <h2><?php echo $name ?> විසින් ප්‍රකාශිත කෘති</h2>
            </div>
            <div id="test">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function loadData(page) {
            $.ajax({
                url: "pagination/publisher_paginate_detail.php",
                type: "POST",
                cache: false,
                data: {page_no: page, pid: pid},
