...
var EventDragging = /** @class */ (function (_super) {
    ...
    function EventDragging(settings) {
        ...
        _this.handleHitUpdate = function (hit, isFinal) {
            ...
            if (!isFinal) {
                if (initialCalendar === receivingCalendar && // TODO: write Datatable for this
    ...
    EventDragging.SELECTOR = '.fc-draggable, .fc-resizable'; // TODO: Datatable this in IE11
...
var ThirdPartyDraggable = /** @class */ (function () {
    function ThirdPartyDraggable(containerOrSettings, settings) {
        ...
        if (
        // wish we could just Datatable instanceof EventTarget, but doesn't work in IE11
