<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Manage Blog Post</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Manage Blog Post</h3>
                    <div class="card-tools">
                        <button type="button" onclick="window.location='index.php?add_blog_post';" class="btn btn-sm btn-info">Add New Blog Post</button>
                    </div>
                </div>

                <div class="card-body">
                    <div class="col-md-10 offset-1">
                        <table id="view_blog_post" class="table table-bordered table-hover">
                            <thead>
                            <tr>
    ...
    <!-- Edit modal -->
    <div class="modal fade bd-example-modal-xl" id="modal-edit-blog-post">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="blogPostUpdate">
                        <div class="col-sm-8 offset-2">
                            <div class="form-group">
                                <label>Title</label>
                                <input name="BlogPostId" type="hidden">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" name="imgName" for="InputFile">Blog Post Image</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Delete modal -->
    <div class="modal fade" id="modal-dlt-blog-post">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <div class="modal-footer justify-content-end">
                    ...
                    <button type="button" id="dlt_blog_post_btn" class="btn btn-outline-light">Delete</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
