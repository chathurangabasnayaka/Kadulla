<div class="content-wrapper">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-10 offset-1">
                        <table id="view_author" class="table table-bordered table-hover">
                            <thead>
                            <tr>
    ...
    <!-- Edit modal -->
    <div class="modal fade bd-example-modal-xl" id="modal-editAuthor">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="authorUpdate">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" name="imgName" for="InputFile">Author Image</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <!-- Delete modal -->
    <div class="modal fade" id="modal-dlt-author">
