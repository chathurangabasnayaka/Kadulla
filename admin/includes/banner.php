<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Main Menu Banner</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Main Menu Banner</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <?php
        $sql_banner = "SELECT * FROM `banner` where state='1' limit 0,3";
...
//            $id = $row_run_slider['id'];
            ...
            <div class="card <?php echo($i ? 'collapsed-card' : '') ?>">
                <div class="card-header">
                    <h3 class="card-title">Main Menu Banner <?php echo $id ?></h3>
                ...
                <div class="card-body">
                    <form role="form" class="bannerForm" method="post" name="form" enctype="multipart/form-data">
                        <div class="row">
