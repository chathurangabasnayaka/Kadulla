<div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" onclick="window.location='index.php?publisher';" class="btn btn-sm btn-info">Add New Publisher</button>
                    </div>
                </div>

                <div class="card-body">
                    <div class="col-md-10 offset-1">
                        <table id="view_publisher" class="table table-bordered table-hover">
                            <thead>
                            <tr>
    ...
    <!-- Edit modal -->
    <div class="modal fade bd-example-modal-xl" id="modal-edit-pub">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="pubUpdate">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" name="imgName" for="InputFile">Publisher Image</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Delete modal -->
    <div class="modal fade" id="modal-dlt-pub">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <div class="modal-footer justify-content-end">
                    ...
                    <button type="button" id="dlt_pub_btn" class="btn btn-outline-light">Delete</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
