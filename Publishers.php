...
<div class="main-wrapper">
    ...
    <?php
    $result_count = mysqli_query($con, "SELECT COUNT(id) FROM `publisher` where is_Active='1'");
...
//                                    $result = mysqli_query($conn,"SELECT * FROM user_table ORDER BY userid ASC LIMIT $start_from, $limit");
                                    ...
                                    $sql = "SELECT * FROM `publisher` WHERE `is_Active`='1' ORDER BY (" . $selectedOption . ") ASC LIMIT $start_from, $limit";
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6 col-12">
                                            <div class="single-product-wrap mb-35">
                                                <div class="product-img product-img-zoom mb-15">
                                                    <a href="publisher-details.php?pid=<?php echo $id ?>">
                                                        <img src="admin/img/publisher/<?php echo $img; ?>" alt="">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="product-content-wrap-2 product-content-position text-center">
                                                    <h3><a href="publisher-details.php?pid=<?php echo $id ?>"><?php echo $name ?></a></h3>
                                                    <div class="pro-add-to-cart">
                                                        <button onclick="window.location.href='publisher-details.php?pid=<?php echo $id ?>'" title="Publisher Details">Details</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-6">
                                                <div class="product-list-img">
                                                    <a href="<?php echo $id ?>">
                                                        <img src="admin/img/publisher/<?php echo $img; ?>" alt="Product Style">
                                                    </a>
                        ...
                        <div class="pro-pagination-style text-center mt-10">
                            <ul>
                                    ...
                                    if ((int)$page!=1){
                                    ?>
                                        <li><a class="prev" href='publishers.php?page=<?php echo ((int)$page)-1 ?><?php echo $limit_qry.$selectedOption_qry ?>'><i class="icon-arrow-left"></i></a></li>
                                        <?php
                                    }
                                ...
                                <?php
                                $result_db = mysqli_query($con,"SELECT COUNT(id) FROM `publisher` where is_Active='1'");
                                $row_db = mysqli_fetch_row($result_db);
                                $total_records = $row_db[0];
                                $total_pages = ceil($total_records / $limit);
                                /* echo  $total_pages; */
                                for ($i=1; $i<=$total_pages; $i++) {
                                    $pagLink = "<li><a href='publishers.php?page=".$i. $limit_qry .$selectedOption_qry."'>".$i."</a></li>";
                                    echo $pagLink;
                                }

                                if ((int)$page!=(int)$total_pages){
                                    ?>
                                    <li><a class="next" href='publishers.php?page=<?php echo ((int)$page)+1 ?><?php echo $limit_qry.$selectedOption_qry ?>'><i class="icon-arrow-right"></i></a></li>
                                    <?php
                                }
...
<script>
    $('#limit').change(function () {
        window.location.href = "publishers.php?<?php echo $qry.$selectedOption_qry . '&lim='?>" + $(this).val();
    });
    $('#filter').change(function () {
        window.location.href = "publishers.php?<?php echo $qry .$limit_qry. '&filter='?>" + $(this).val();
    });
</script>
