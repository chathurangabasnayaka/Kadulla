...
<div class="main-wrapper">
    ...
    <?php
    $TID = $_GET['tid'];
    $sql = "SELECT * from `book_translator` where id='$TID'";
    ...
    <div class="related-product pb-115">
        <div class="container">
            <div class="section-title mb-45 text-center">
                <h2><?php echo $name ?> විසින් පරිවර්තනය කරන ලද කෘති</h2>
            </div>
            <div id="test">
...
<?php include 'include/js.php' ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            let tid = '<?php echo $TID; ?>';
            function loadData(page){
                $.ajax({
                    url  : "pagination/translator_paginate_detail.php",
                    type : "POST",
                    cache: false,
                    data : {page_no:page,tid: tid },
